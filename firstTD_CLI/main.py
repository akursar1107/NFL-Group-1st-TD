...
import pytz
from nfl_core.config import API_KEY, SPORT
from nfl_core.data import load_data_with_cache, get_season_games
        ...
        for player, price_data in game_best_prices.items():
            ...
            if stats:
                ...
                if ev > 0:
                    ...
                    from nfl_core.stats import calculate_fair_odds
